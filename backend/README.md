...
## Project Structure
    ...
    ├── patient_snowflake_39334  # Django project configurations
...
1. Clone this repo and `cd patient_snowflake_39334`
...
2. Clone this repo and `cd patient_snowflake_39334`
