"""
Django settings for patient_snowflake_39334 project.
...
ROOT_URLCONF = 'patient_snowflake_39334.urls'
...
WSGI_APPLICATION = 'patient_snowflake_39334.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_snowflake_39334 API",
    "DESCRIPTION": "API documentation for patient_snowflake_39334 App",
    "VERSION": "v1",
}
